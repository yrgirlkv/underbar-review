(function() {
  ...
  _.last = function(array, n) {
    return n === 0 ? [] : n === undefined ? array[array.length-1] : n > array.length ? array.slice() : array.slice(n-1, array.length);
  };
  ...
  _.every = function(collection, iterator) {
    ...
    iterator !== undefined ? iterator = iterator : iterator = _.identity;
